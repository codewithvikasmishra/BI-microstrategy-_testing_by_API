# BI-microstrategy-_testing_by_API
...
To make it easy it would be good if you have API testing tool available with you so you can understand the schema of output. Also, you should have some basic knowledge of json schema and how you can call the key and values from there in python.
